// ==============================================================================
// PhysicsList.cc - Implementation (Minimal Verbosity Version)
// ==============================================================================
...
{
    SetVerboseLevel(0);  // Changed from 2 to 0 for minimal verbosity
...
void PhysicsList::SetCuts()
{
    ...
    // Remove verbose output - comment out or set to 0
    // if (verboseLevel > 0) {
    //     DumpCutValuesTable();
    // }
}